...
export default function AboutFirm() {
  return (
    <section className="w-full bg-[#FFFFFF]">
      <div className="page-container relative pt-[50px] pb-12">

        {/* bg world map watermark */}
        <div
        ...
        <div className="relative z-10 flex flex-col lg:flex-row items-stretch gap-6 lg:gap-8">
          ...
          {/* Left: About Firm label card */}
          <div className="w-full lg:w-[18%] flex-shrink-0 pt-4">
            <div className="bg-[#f2f2f2] rounded-[24px] p-8 flex items-center justify-start lg:h-[220px]">
              <h2 className="text-[20px] font-extrabold text-[#111827] leading-[1.3] tracking-wider">
                ABOUT<br />FIRM
              </h2>
            </div>
          </div>
          ...
          <div className="w-full lg:w-[42%] flex flex-col justify-start pl-0 lg:pl-6 pr-0 lg:pr-4 pt-4">
            ...
            <div className="grid grid-cols-2 gap-y-8 gap-x-8 lg:gap-x-12 w-full lg:w-[90%] relative">
              {firmStats.slice(0, 2).map((stat) => (
                <div key={stat.id}>
                  <div className="text-[28px] lg:text-[32px] font-extrabold text-[#111827] mb-2">{stat.value}</div>
          ...
          {/* Right: Location + Building image */}
          <div className="w-full lg:w-[40%] flex flex-col items-end pt-3 px-0 lg:px-6">
            <div className="w-full flex justify-end mb-6">
              <button className="bg-[#ff6c0e] text-[#000000] text-[11px] font-extrabold py-3 pl-8 pr-5 rounded-full flex items-center gap-6 lg:gap-[100px] shadow-sm hover:bg-[#e05f0b] transition-colors focus:outline-none uppercase">
                <span>WE ARE LOCATED</span>
                <span>INDIA ▼</span>
              </button>
            </div>

            <div className="w-full h-[300px] lg:h-[530px] relative rounded-[28px] overflow-hidden shadow-lg">
              <img
