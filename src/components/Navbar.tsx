...
export default function Navbar() {
  return (
    <nav className="w-full h-[88px] flex items-center justify-between px-6 lg:px-[60px] bg-[#FFFFFF] border-b border-gray-100">
      
      <div className="flex items-center">
        <div className="flex flex-col items-center justify-center w-[52px] h-[52px] relative text-[#111827]">
      ...
      <div className="flex items-center h-full">
        <div className="hidden lg:flex items-center space-x-[42px] text-[12px] font-extrabold text-[#111827] tracking-widest h-full pr-10 border-r border-transparent">
          {navLinks.map((link) => (
        ...
        <div className="flex items-center space-x-7 pl-10 text-[12px] font-extrabold text-[#111827] tracking-widest h-full">
